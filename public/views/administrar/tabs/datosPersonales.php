    ...
    <div class="card-body mb-5" style="border-bottom-right-radius: 20px;border-bottom-left-radius:20px;">
        ...
        <div class="form-group row">
            ...
            <div class="form-group col-lg-4 col-md-4 col-sd-12 col-xs-12">
                ...
                <input disabled readonly id="ciudad" class="form-control" value="<?= $solicitud['ciudad'] ?>" title="Seleccionar" name='ciudad' style="display:block !important;" required>
            ...
            <div class="form-group col-lg-4 col-md-4 col-sd-12 col-xs-12 ">
                ...
                <input disabled readonly id="direccion-calle" class="form-control" value="<?= $solicitud['calle'] ?>">
            </div>
            <div class="form-group col-lg-4 col-md-4 col-sd-12 col-xs-12 ">
                <label for="direccion-numero">Número </label>
                <input disabled readonly id="direccion-numero" class="form-control" value="<?= $solicitud['nro_calle'] ?>">
            </div>
            <div class="form-group col-lg-4 col-md-4 col-sd-12 col-xs-12 ">
            ...
            <div class="row">
                <div class="col-md-12 my-1">
                    <div class="float-md-right float-xs-left">
                        <input class="btn btn-primary" type="submit" disabled readonly id="submitBtn1" value="Confirmar y Guardar" name="personalesSubmit" />
                    </div>
                </div>
            </div>
        </div>
