...
function checkArchivo(file) {
  ...
  if (fileSize > max_file_size) {
    ...
    $(file)
      ...
      .addClass("d-block");
    alert(
      `El tamaño del archivo max es de ${max_file_size} MB. Su archivo pesa ${~~fileSize} MB`
    );
  } else {
  ...
  if (total_fields < max_fields) {
    $("#inputs-titulos").append(
      "<div class='form-group col-lg-6 col-md-6 col-sd-12 col-xs-12 '>" +
        ...
        numInputs +
        "' class='required'>Elegir título y/o curso " +
        numInputs +
        " </label>" +
        ...
        numInputs +
        "' class='required'>Título o certificado " +
        numInputs +
...
// paso 4 actividades
// revisa que tenga al menos una actividad marcada y el checkbox de confirmación para habilitar el botón de submit
function checkboxes() {
...
// paso 5 condiciones. revisa que estén marcados los dos checkboxes
